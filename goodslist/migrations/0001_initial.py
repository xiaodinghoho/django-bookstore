    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='goodslist.AreaInfo')),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goodslist.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            ...
            name='orders_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goodslist.Orders'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goodSort',
