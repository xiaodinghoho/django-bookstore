    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='detail.AreaInfo')),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(blank=True, max_length=20, null=True)),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detail.Goods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detail.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detail.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            ...
            name='orders_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detail.Orders'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='detail.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
